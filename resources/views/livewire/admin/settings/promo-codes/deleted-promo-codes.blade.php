<div class="min-h-[550px] container mx-auto p-6 ">
    ...
    @if ($deletedPromoCodes->isEmpty())
    <!-- Empty Page Message -->
    <div class="text-center py-10">
        <p class="text-gray-500 text-lg font-semibold">No deleted promo codes yet.</p>
    </div>
    @else
    ...
    <div>
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 space-x-2 text-center">
                            <x-button wire:click="restorePromoCode({{ $promoCode->id }})" class="mb-2">
                                Restore
                            </x-button>
                            <!-- Delete Forever Button -->
                            <x-danger-button wire:click="confirmDeleteForever({{ $promoCode->id }})">
                                Delete Forever
                            </x-danger-button>
                        </td>
                    </tr>
        ...
        <x-dialog-modal wire:model.live="confirmItemDelete" type="danger">
            ...
            <x-slot name="footer">
                ...
                <x-danger-button class="ms-3" wire:click="deletePromoCodeForever({{ $promoCode->id }})"
