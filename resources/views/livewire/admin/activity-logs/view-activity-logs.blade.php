                    ...
                    <div class="relative w-full">
                        ...
                        <div class="w-full">
                            <label for="start_date"
                                ...
                                Start Date</label>
                            <input type="date" wire:model="start_date" id="start_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                    ...
                    <div class="border-l-2 border-gray-200 dark:border-gray-600 pl-4 pt-8">
                        ...
                        <div class="relative mb-8 flex items-start">
                            ...
                            <div class="flex-1 bg-white dark:bg-gray-700 rounded-lg shadow p-4 ml-4">
                                ...
                                @if ($hasChanges)
                                <button type="button" class="mt-3 text-blue-600 hover:underline text-sm"
                                ...
                                <div id="{{ $collapseId }}"
                                    ...
                                    <ul class="list-disc list-inside space-y-1">
                                        ...
                                        <li>
                                            ...
                                            "<span class="text-green-600">{{ is_array($val) ? json_encode($val) : $val
                                                ?? 'N/A' }}</span>"
                                        </li>
                                        @endforeach
                                    </ul>
                                    ...
                                    <ul class="list-disc list-inside space-y-1">
                                        ...
                                        <li>
                                            <strong>{{ ucfirst(str_replace('_', ' ', $key)) }}:</strong>
                                            "<span class="text-red-500">{{ is_array($val) ? json_encode($val) : $val ??
                                                'N/A' }}</span>"
                                        </li>
                                        @endforeach
                                    </ul>
                                    ...
                                    <ul class="list-disc list-inside space-y-1">
                                        ...
                                        <li>
                                            <strong>{{ ucfirst(str_replace('_', ' ', $key)) }}:</strong>
                                            "<span class="text-red-500">{{ is_array($oldVal) ? json_encode($oldVal) :
                                                $oldVal ?? 'N/A' }}</span>"
                                            was updated to
                                            "<span class="text-green-600">{{ is_array($newVal) ? json_encode($newVal) :
                                                $newVal ?? 'N/A' }}</span>"
                                        </li>
                                        @endif
                                        @endforeach
                    ...
                    <tr class="bg-gray-50 dark:bg-gray-800">
                        <td colspan="6" class="px-4 py-2 text-sm text-gray-600 dark:text-gray-300">
                            ...
                            <ul class="list-disc list-inside space-y-1">
                                ...
                                <li>
                                    <strong>{{ ucfirst(str_replace('_', ' ', $key)) }}:</strong>
                                    "<span class="text-red-500">{{ is_array($oldVal) ? json_encode($oldVal) : $oldVal ??
                                        'N/A' }}</span>"
                                    was updated to
                                    "<span class="text-green-600">{{ is_array($newVal) ? json_encode($newVal) : $newVal
                                        ?? 'N/A' }}</span>"
                                </li>
                                @endif
                                @endforeach
