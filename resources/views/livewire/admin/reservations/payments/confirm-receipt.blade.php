        ...
        @if ($payments->isNotEmpty())
            @foreach ($payments as $payment)
                <div>
                    ...
                    <p><strong>Payment Method:</strong> {{ $payment->paymentMethod->mode_of_payment_name }}</p>
                    <p><strong>Amount Paid:</strong> {{ $payment->amount_paid }}</p>
                    <p><strong>Payment Type:</strong> {{ $payment->payment_type }}</p>
                    <p><strong>Payment Reference Number:</strong> {{ $payment->payment_reference_number ?? 'N/A' }}</p>
                    <p><strong>Upload Payment Date:</strong> {{ $payment->payment_date ?? 'N/A' }}</p>
                    ...
                    <p><strong>Paid At:</strong> {{ $payment->paid_at ?? 'To be verified' }}</p>
