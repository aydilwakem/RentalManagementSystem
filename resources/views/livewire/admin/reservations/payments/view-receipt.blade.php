        ...
        <div class="space-y-6">
            <div class="bg-gray-50 rounded-md p-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-gray-900">
                        ...
                        @else
                            <input type="number" wire:model.defer="amount_paid" onwheel="this.blur()"
            ...
            <div class="bg-gray-50 rounded-md p-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-gray-900"> {{ $payment->paymentMethod?->mode_of_payment_name ?? 'N/A' }}</div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-md p-4">
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-gray-900">
                        {{ \Carbon\Carbon::parse($payment->payment_date)->format('F j, Y g:i A') }}
                    </div>
                </div>
            </div>
