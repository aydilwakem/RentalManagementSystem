<div class="min-h-[550px] container mx-auto border-t border-gray-300">
    ...
    <div class="text-center py-10">
        <p class="text-gray-500 text-lg font-semibold">No rooms rates for Room: {{ $room->name_number}}. <br> Click
            "Create Room
            Rate" to add a new
            room rate.</p>
            ...
            <table class="w-full text-left">
                <thead class="text-sm text-gray-700 bg-gray-200">
                    ...
                    <tr>
                        ...
                        {{-- Is active --}}
                        <th scope="col" class="px-4 py-3" wire:click="setSortBy('is_active')">
                            <button class="flex items-center">
                                Status
                                @if ($sortBy !== 'is_active')
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
