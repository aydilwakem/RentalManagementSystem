                ...
                <div class="flex items-center justify-between d p-4">
                    ...
                    <div class="flex space-x-3">
                        <div class="flex space-x-3 items-center">
                            <label class="w-40 text-sm font-medium text-gray-900">Rate Type :</label>
                ...
                <table class="w-full text-left">
                    <thead class="text-sm text-gray-700 bg-gray-200">
                        ...
                        <tr>
                            ...
                            {{-- End Date --}}
                            <th scope="col" class="px-4 py-3" wire:click="setSortBy('end_date')">
                                <button class="flex items-center">
                                    End Date
                                    @if ($sortBy !== 'end_date')
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    @forelse ($roomRates as $roomRate)
                        <tr class="border-b">
                            ...
                            {{-- Room ID --}}
                            <td class="px-4 py-3">{{ $roomRate->room->name_number ?? 'N/A' }}</td>
                            {{-- Room Rate Name --}}
                            ...
                            <td class="px-4 py-3">
                                ...
                                @endif
                                </td> <td class="px-4 py-3 flex items-center justify-center space-x-3">
                                <!-- View Icon -->
                                @can('room-rate-view')
                    ...
                    @endforelse
                    </table> {{-- Per Page --}} <div class="py-4 px-3">
                    <div class="flex ">
                    ...
                    <x-dialog-modal wire:model.live="confirmItemDelete" type="danger">
                        <x-slot name="title">
                            ...
                            <x-secondary-button wire:click="$set('confirmItemDelete', false)" wire:loading.attr="disabled">
                                ...
                                <x-danger-button class="ms-3" wire:click="deleteRoomRate" wire:loading.attr="disabled">
                                    {{ __('Delete Room Rate') }}
                                    </x-danger-button>
                        </x-slot>
                    </x-dialog-modal>
