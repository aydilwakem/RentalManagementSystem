<div>
    ...
    <x-slot name="header">
        ...
        <!-- Navigation -->
        <x-breadcrumbs :items="[
            ['label' => 'Features', 'url' => route('admin.features')],
            ['label' => 'Create Feature', 'url' => route('admin.create-feature')],
        ]" />
    </x-slot>
    ...
    <div class="py-3">
        <div
            ...
            <div class="relative flex items-center mb-4">
                <!-- Title -->
                <h2 class="text-2xl font-bold text-gray-900 w-full text-center dark:text-white">Add New Feature</h2>
            ...
            <form wire:submit.prevent="" class="flex flex-col h-full space-y-6 min-h-[200px]">
                <!-- Name of Feature -->
                <div class="mt-4">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Name <span
                ...
                <div>
                    ...
                    <input type="number" wire:model="quantity" id="quantity" onwheel="this.blur()" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                            dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400" min="1" required
