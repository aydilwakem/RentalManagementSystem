<div class="min-h-[550px] container mx-auto p-6 ">
    ...
    @if ($deletedUsers->isEmpty())
        ...
        <div class="text-center py-10">
            <p class="text-gray-500 text-lg font-semibold">No deleted users yet.</p>
        </div>
    @else
        ...
        <div>
                ...
                <table class="w-full text-left">
                    <thead class="text-sm text-gray-700 bg-gray-200">
                        <tr>
                            ...
                            <!-- User Name -->
                            <th scope="col" class="px-4 py-3 text-left">User Name</th>
                        ...
                        @foreach ($deletedUsers as $user)
                            <tr class="border-b">
                                <td class="px-4 py-3 font-medium text-gray-900 text-left">
                                    {{ $fakeIDs[$user->id] ?? 'USER-???' }}</td>
                                <td class="px-4 py-3 text-left">{{ $user->name }} {{ $user->last_name }}</td>
                                <td class="px-4 py-3 space-x-2 text-center">
                                    <x-button wire:click="restoreUser({{ $user->id }})">
                                        Restore
                                    </x-button>
                                    ...
                                    <x-button
                                        ...
                                        wire:click="confirmDeleteForever({{ $user->id }})">
                                        Delete Forever
                                    </x-button>
                                </td>
                            </tr>
            ...
            <x-dialog-modal wire:model.live="confirmItemDelete" type="danger">
                ...
                <x-slot name="footer">
                    ...
                    <x-danger-button class="ms-3" wire:click="deleteUserForever({{ $user->id }})"
