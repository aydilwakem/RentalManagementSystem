<div>
    ...
    <x-slot name="header">
        ...
        <x-breadcrumbs :items="[
            ...
            ['label' => 'Edit Event', 'url' => route('admin.edit-event', ['event' => $event->id])],
        ]" />
    </x-slot>
    ...
    <div class="py-3">
        <div
            class="mx-auto max-w-7xl sm:px-6 lg:px-8 bg-white rounded-lg border shadow-md p-6 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div>
                                <label for="total_amount"
                                    ...
                                    <span class="text-xs text-gray-500 dark:text-gray-300">(Current Event Cost:
                        ...
                        @if (count($selectedRooms) > 0 || count($selectedActivities) > 0 || count($selectedServices) > 0)
                            <div
                                ...
                                @if (count($selectedRooms) > 0)
                                    <div class="mb-3 bg-white rounded-md border p-3 dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
                    ...
                    @else
                        @foreach ($rooms as $room)
                            ...
                            {{-- Check if room is booked - Updated to match CreateEvent logic --}}
                            @if (!$room->is_booked)
                                <div
                                    ...
                                    <div class="flex justify-between items-center">
                                        <div>
                                            <h4 class="text-xl font-semibold mb-2 dark:text-gray-900">{{ $room->name_number }}</h4>
                                        ...
                                        <x-button wire:click="SelectedRooms({{ $room->id }})"
                                            class="dark:bg-green-600  text-white">
                                            Add Room
                                        </x-button>
                                    </div>
                                </div>
