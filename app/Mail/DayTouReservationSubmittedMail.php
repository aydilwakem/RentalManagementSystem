...
class DayTouReservationSubmittedMail extends Mailable
{
    ...
    {
        return $this->view('guest.emails.daytour-submitted')
            ->subject('Day Tour Reservation Successfully Submitted')
            ->with([
