...
class DayTouReservationConfirmedMail extends Mailable
{
    ...
    {
        return $this->view('guest.emails.daytour-confirmed')
            ->subject('Day Tour Reservation Confirmed!')
            ->with([
                ...
                'requests' => $this->dayTourData['requests'],
                'request_reply' => $this->dayTourData['request_reply'],
