...
{
    // ------------- A TEST TO VERIFY ADMIN HAS THESE PERMISSIONS
    protected $adminPermissions = [
     ...
     public function test_admin_role_has_all_expected_permissions()
    {
        ...
        foreach ($this->adminPermissions as $permissionName) {
            ...
            $this->assertTrue(
                ...
                "Admin role is missing permission: {$permissionName}"
            );
        }
    }
}
