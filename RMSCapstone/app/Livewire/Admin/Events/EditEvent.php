...
class EditEvent extends Component
{
    ...
    public function mount(Event $event)
    {
        ...
        $this->event_hall_id = $event->event_hall_id;
        $this->company_name = $event->company_name;
        $this->contact_person = $event->contact_person;
        $this->email = $event->email;
        $this->event_date_start = optional($event->event_date_start)->format('Y-m-d');
        $this->event_date_end = optional($event->event_date_end)->format('Y-m-d');
        $this->event_time = optional($event->event_time)->format('H:i');
