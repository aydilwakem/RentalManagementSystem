        ...
        <div class="w-full rounded-xl shadow bg-gray-50 overflow-hidden">
            ...
            <div class="p-4 space-y-6">
                ...
                <div>
                    ...
                    <div class="mb-2 flex items-center gap-2">
                        <textarea type="text" wire:model="requests" rows="3"
                            class="w-full border border-gray-300 rounded-md px-3 py-2 resize-none focus:outline-none focus:ring-green-600 focus:border-green-600"
                ...
                @if ($bringingPets)
                    <div>
                        <!-- Pet Fee Notice -->
                        <div
                            class="w-1/2 text-sm text-yellow-800 bg-yellow-100 p-2 rounded-md border border-yellow-300">
                        ...
                        <div class="mb-2 mt-2">
                            ...
                            <h3 class="block text-sm font-medium text-gray-800 mb-1">
                                Added Pets: {{ count($pets) }}/{{ $this->maxPetsAllowed }}
                            </h3>

                            @if (count($pets) > 0)
                                <ol
                                    class="space-y-3 list-decimal pl-6 text-gray-700 p-3 bg-white rounded-2xl border border-gray-300">
                                            ...
                                            <div class="flex justify-between items-center">
                                                ...
                                                <div class="space-x-5 flex items-center">
                                                    <button wire:click="editGuestPet({{ $index }})"
                                                        class="inline-flex items-center text-yellow-600 hover:text-yellow-700 hover:underline font-sm transition duration-150">
            ...
            @if ($showGuestModal)
                <div id="guestModal"
                    ...
                    <div class="bg-white rounded-lg shadow-lg w-[90%] md:w-[650px] max-h-[100vh] overflow-y-auto">
                        ...
                        <div
                            ...
                            <h2 class="text-2xl font-semibold text-green-700 dark:text-green-300">Enter Additional
                                Guest Details</h2>
