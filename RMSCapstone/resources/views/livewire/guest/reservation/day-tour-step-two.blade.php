                    ...
                    <div class="flex items-center justify-between">
                        <button type="button" wire:click="decrementAdult"
                            class="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center
                               hover:bg-red-200 transition text-gray-700 disabled:opacity-40 disabled:cursor-not-allowed"
                ...
                <div class="p-4 bg-white rounded-xl border border-gray-300 shadow-sm">
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-semibold text-gray-800">₱{{ number_format($adultCount * $selectedRate->adult_rate, 2) }}</span>
                        </div>
                        @if ($kidCount > 0)
                            <div class="flex justify-between">
                                ...
                                <span
                                    class="font-semibold text-gray-800">₱{{ number_format($kidCount * $selectedRate->kid_rate, 2) }}</span>
                            </div>
                        @endif
                        <div class="flex justify-between border-t border-green-200 pt-3 mt-3">
                            ...
                            <span
                                class="font-extrabold text-xl text-green-700">₱{{ number_format($this->subtotal, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
