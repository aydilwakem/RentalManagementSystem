                                            ...
                                            <p class="text-base font-normal text-gray-700 dark:text-gray-400">
                                                    ...
                                                    <p class="mt-4 text-lg font-medium">
                                                        ...
                                                        @if ($room->rate_name || $room->rate_type)
                                                            <span class="text-green-700 font-bold">
                                                                ...
                                                                ({{ $room->rate_name }}{{ $room->rate_type ? ' Rate - ' . $room->rate_type : '' }})
                                                            </span>
                                                        @endif
                                                    </p>
                                                ...
                                                <div class="mt-auto pt-2 flex flex-col justify-between">
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        @if ($roomInCart)
                                                            <span
                                                                class="block w-full text-center py-2 bg-yellow-300 text-gray-800 font-semibold rounded">
                                                                In Cart
                                                            </span>
                                                        @elseif ($room->is_booked)
                                                            <span
                                                                class="block w-full text-center py-2 bg-red-500 text-white-100 font-semibold rounded">
                                                                Sold Out
                                                            </span>
