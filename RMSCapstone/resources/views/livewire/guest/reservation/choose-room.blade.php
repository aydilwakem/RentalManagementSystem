                                    ...
                                    <div class="md:flex">
                                        ...
                                        <div class="w-full md:w-1/3">
                                            ...
                                            <div class="relative w-full h-48 md:h-full overflow-hidden rounded-xl">
                                                ...
                                                @if ($room->is_booked)
                                                    <div
                                                        class="absolute top-3 right-[-40px] bg-red-600 text-white text-xs font-bold py-1 px-12
                                        ...
                                        <div class="md:w-2/3 p-4 flex flex-col md:flex-row justify-between gap-4 bg-white">
                                                ...
                                                <div>
                                                    ...
                                                    @if ($room->category->name === 'Pool House' && $room->name_number !== 'Pool House')
                                                        <div
                                                            ...
                                                            This room is one of the exclusive subrooms within the Pool House property.
                                                            When the entire Pool House is booked, this room becomes unavailable for
                                                            individual booking.
                                                            @if ($poolHouseBooked)
                                                                <div class="mt-1 italic text-gray-600">Currently unavailable — the full Pool
                                                    ...
                                                    @elseif ($room->category->name === 'Pool House' && $room->name_number === 'Pool House')
                                                        @if ($anySubRoomBooked)
                                                            <div
                                                                ...
                                                                Some of the subrooms under the Pool House are currently reserved, which may
                                                                        ...
                                                                        @else
                                                                            ...
                                                                            <span class="text-green-700 font-bold">
                                                                                ...
                                                                                ₱{{ number_format($appliedRate['average_rate'], 2) }}<span
                                                                                    class="text-sm text-gray-500">/per night</span>
                                                                            </span>
                                                                            <span
                                                ...
                                                <div id="modal-room-{{ $room->id }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="mt-4 text-sm text-gray-700 p-3">
                                                            ...
                                                            {{ $room->max_kids }} Kids.
                                                            The base rate is
                                                            ₱{{ number_format($room->amount, 2) }}{{ $room->extra_person_charge ? ',
                                                            with an extra charge of ₱' . number_format($room->extra_person_charge,
                                                            ...
                                                            <!-- Room Amenities -->
                                                            <div class="mt-2 mb-4">
                                                                <h3 class="font-semibold text-gray-700 mb-2 text-lg">Included
                                                                    Amenities</h3>
                                            ...
                                            <div class="mt-auto pt-2 flex flex-col justify-between">
                                                ...
                                                @php
                                                    ...
                                                    $poolHouseInCart = $cartCollection->contains(function ($item) use ($rooms) {
                                                        $roomItem = $rooms->firstWhere('id', $item['room_id']);
                                                        return $roomItem && $roomItem->category->name === 'Pool House' && $roomItem->name_number === 'Pool House';
                                                    });

                                                    // Check if any subroom is in the cart
                                                    $anySubRoomInCart = $cartCollection->contains(function ($item) use ($rooms) {
                                                        $roomItem = $rooms->firstWhere('id', $item['room_id']);
                                                        return $roomItem && $roomItem->category->name === 'Pool House' && $roomItem->name_number !== 'Pool House';
                                                    });
                                                    ...
                                                    $isUnavailable =
                                                        $room->is_booked ||
                                                        ($poolHouseBooked && $room->category->name === 'Pool House' && $room->name_number !== 'Pool House') ||
                                                        ($anySubRoomBooked && $room->category->name === 'Pool House' && $room->name_number === 'Pool House') ||
                                                        ($poolHouseInCart && $room->category->name === 'Pool House' && $room->name_number !== 'Pool House') ||
                                                        ($anySubRoomInCart && $room->category->name === 'Pool House' && $room->name_number === 'Pool House');
                                                @endphp
