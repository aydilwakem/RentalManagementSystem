                                    ...
                                    <div class="md:w-2/3 p-4 flex flex-col md:flex-row justify-between gap-4 bg-white">
                                        ...
                                        <div class="md:w-2/3">
                                            ...
                                            <div class="flex space-x-1">
                                                <h4 class="text-2xl font-semibold mb-1">{{ ucwords($room->name_number)
                                                    }} </h4>
                                                <div class="mt-1">
                                                    @livewire('guest.reservation.property-reviews', ['propertyId' =>
                                                    $room->id], key('reviews-' . $room->id))
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                @if ($room->category->name === 'Pool House' && $room->name_number !==
                                                'Pool House')
                                                <div
                                                    ...
                                                    property.
                                                    When the entire Pool House is booked, this room becomes unavailable
                                                    for
                                                    individual booking.
                                                    @if ($poolHouseBooked)
                                                    <div class="mt-1 italic text-gray-600">Currently unavailable — the
                                                        full Pool
                                                        House is reserved.</div>
                                                    @endif
                                                </div>
                                                @elseif ($room->category->name === 'Pool House' && $room->name_number
                                                === 'Pool House')
                                                @if ($anySubRoomBooked)
                                                <div
                                                    ...
                                                    Some of the subrooms under the Pool House are currently reserved,
                                                    which may
                                            ...
                                            <div class="mt-4 border-2 rounded-md p-2 mb-2 bg-gray-50">
                                                ...
                                                count($appliedRates) > 0 && $hasMultipleRates)
                                                                ...
                                                                <div class="flex justify-between items-center text-xs">
                                                                    <span class="text-gray-600">
                                                                        ...
                                                                        <span class="font-medium">{{
                                                                            $appliedRate['name'] }}</span>
                                                                        <span class="text-gray-500">(₱{{
                                                                            number_format($appliedRate['average_rate'],
                                                                            2) }}/night)</span>
                                                                    </span>
                                                                    <span class="font-semibold text-gray-700">
                                                                        ₱{{ number_format($appliedRate['total_amount'],
                                                                        2) }}
                                                                    </span>
                                                                </div>
                                                                @endforeach
                                        ...
                                        <div class="mt-auto pt-2 flex flex-col justify-between">
                                            ...
                                            return $roomItem && $roomItem->category->name === 'Pool House' &&
                                            ...
                                            $isUnavailable =
                                            $room->is_booked ||
                                            ($poolHouseBooked && $room->category->name === 'Pool House' &&
                                            $room->name_number !== 'Pool House') ||
                                            ($anySubRoomBooked && $room->category->name === 'Pool House' &&
                                            $room->name_number === 'Pool House') ||
                                            ($poolHouseInCart && $room->category->name === 'Pool House' &&
                                            $room->name_number !== 'Pool House') ||
                                            ($anySubRoomInCart && $room->category->name === 'Pool House' &&
                                            $room->name_number === 'Pool House');
                                            @endphp
