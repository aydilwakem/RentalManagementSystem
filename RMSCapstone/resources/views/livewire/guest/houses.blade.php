<div class="max-w-[90%] mx-auto px-4 py-7 mb-8">
    ...
    <p class="text-lg text-gray-700 text-center mb-5">
        ...
        or call this number <span class="text-green-600">{{ $contactNumber }}</span> for more information and lease
        agreements.
    </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div
            ...
            <div x-data="{
                ...
                }" class="relative w-full h-[250px] overflow-hidden rounded-t-lg" @mouseenter="hover = true"
                ...
                <div>
                    <template x-for="(image, index) in images" :key="index">
                        <img x-show="active === index" :src="'/storage/' + image"
                            ...
                            x-transition:enter-end="opacity-100" :alt="'House image ' + (index + 1)"
                ...
                <div class="absolute bottom-2 left-1/2 transform -translate-x-1/2 flex gap-1">
                    <template x-for="(image, index) in images" :key="index">
                        <button @click="active = index" :class="{
