            ...
            <div class="px-4 space-y-1 flex flex-col overflow-y-auto max-h-[36rem]">
                ...
                <div x-data="dropdown" class="relative">
                    ...
                    <div @click="toggle('houses')"
                        class="flex justify-between items-center space-x-2 rounded-md p-2 cursor-pointer hover:text-white hover:bg-primary-700
                            {{ Route::is('admin.leases*') || Route::is('admin.properties*') || Route::is('admin.tenants*') || Route::is('admin.features*') ? 'text-white bg-primary-600' : 'text-gray-400' }}">
                        <div class="flex items-center space-x-2">
                ...
                <div x-data="dropdown" class="relative">
                    ...
                    <div x-cloak x-show="open" @click.outside="open = false"
                        ...
                        <!-- Daytour Report -->
                        @can('daytour-reports')
                        <a href="{{ route('admin.daytour-reports') }}" wire:navigate
                            class="block px-3 py-2 {{ Route::is('admin.daytour-reports') ? 'underline text-white' : 'hover:text-white hover:underline' }} rounded-lg transition">
                            <h1 class="cursor-pointer">Day Tour</h1>
                        </a>
                        @endcan
