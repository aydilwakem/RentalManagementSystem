            ...
            <div class="px-4 space-y-1 flex flex-col overflow-y-auto max-h-[36rem]">
                ...
                <div x-data="dropdown" class="relative">
                    ...
                    <div x-cloak x-show="open" @click.outside="open = false"
                        ...
                        <a href="{{ route('admin.lease-reports') }}" wire:navigate
                            class="block px-3 py-2 {{ Route::is('aadmin.lease-reports') ? 'underline text-gray-200' : 'hover:text-gray-200 hover:underline' }} rounded-lg transition">
                            <h1 class="cursor-pointer">Lease Reports</h1>
                        </a>
                ...
                <div x-data="dropdown" class="relative">
                    ...
                    <div @click="toggle('events')"
                        class="flex justify-between items-center space-x-2 rounded-md p-2 cursor-pointer hover:text-gray-200 hover:bg-green-700
                                                            {{ Route::is('admin.events*') || Route::is('admin.event-halls*') || Route::is('admin.event-categories*') ? 'text-gray-200 bg-green-600' : 'text-gray-400' }}">
                        <div class="flex items-center space-x-2">
                ...
                <div x-data="dropdown" class="relative">
                    ...
                    <div @click="toggle('report')"
                        class="flex justify-between items-center space-x-2 rounded-md p-2 cursor-pointer hover:text-gray-200 hover:bg-green-700
                                {{ Route::is('admin.reservation-reports*') || Route::is('admin.invoice-list*') || Route::is('admin.payments*') ? 'text-gray-200 bg-green-600' : 'text-gray-400' }}">
                        <div class="flex items-center space-x-2">
                    ...
                    <div x-cloak x-show="open" @click.outside="open = false"
                        ...
                        <a href="{{ route('admin.reservation-reports') }}" wire:navigate
                            ...
                            <h1 class="cursor-pointer">Reports</h1>
                        </a>
                        @endcan
