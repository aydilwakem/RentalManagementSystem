    ...
    <div>
        <div
            ...
            <div class="relative flex items-center mb-4">
                <!-- Title -->
                <h2 class="text-2xl font-bold text-gray-900 w-full text-center dark:text-white">Edit Service</h2>
            ...
            <form wire:submit.prevent="">
                ...
                <div class="flex justify-between items-center space-y-2 mt-6">
                    ...
                    <x-button wire:loading.attr="disabled" wire:click="confirmEdit({{ $service->id }})">
                        Save Changes
                    </x-button>
                </div>
            </form>
            ...
            <x-dialog-modal wire:model.live="confirmEditItem">
                ...
                <x-slot name="footer">
                    ...
                    <x-button class="ms-3 bg-green text-white" wire:click="updateService({{ $service->id }})"
