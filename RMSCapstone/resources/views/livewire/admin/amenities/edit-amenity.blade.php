    ...
    <div class="py-3">
        <div
            ...
            <div class="relative flex items-center mb-4">
                <!-- Title -->
                <h2 class="text-2xl font-bold text-gray-900 w-full text-center dark:text-white">Edit Amenity</h2>
        ...
        <x-dialog-modal wire:model.live="confirmEditItem">
            ...
            <x-slot name="footer">
                ...
                <x-button class="ms-3" wire:click="updateAmenity({{ $amenity->id }})" wire:loading.attr="disabled">
                    {{ __('Save Changes') }}
                </x-button>
            </x-slot>
        </x-dialog-modal>
