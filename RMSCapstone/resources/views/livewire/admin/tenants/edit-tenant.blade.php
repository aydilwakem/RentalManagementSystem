<div>
    ...
    <x-slot name="header">
        ...
        <x-breadcrumbs :items="[
            ...
            ['label' => 'Edit Tenant', 'url' => route('admin.edit-tenant', ['tenant' => $tenant->id])],
        ]" />
    </x-slot>
        ...
        <div
            ...
            <form wire:submit.prevent="">
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 col-span-2">
                        ...
                        <div>
                            <label for="first_name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">First
                                Name <span class="text-red-500">*</span></label>
                            <input type="text" wire:model="first_name" id="first_name" placeholder="Ex. Juan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                        ...
                        <div>
                            <label for="middle_name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Middle
                                Name</label>
                            <input type="text" wire:model="middle_name" id="middle_name" placeholder="Ex. Mercado"
                        ...
                        <div>
                            <label for="last_name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Last
                                Name <span class="text-red-500">*</span></label>
                            <input type="text" wire:model="last_name" id="last_name" placeholder="Ex. Dela Cruz" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                                dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400"
                                required>
                            @error('last_name')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                    ...
                    <div>
                        <label for="suffix"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Suffix</label>
                        <input type="text" wire:model="suffix" id="suffix" placeholder="Ex. Jr., Sr., III" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                            dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400">
                        @error('suffix')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="email" wire:model="email" id="email" placeholder="Ex. juan.delacruz@example.com"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="contact_number" id="contact_number"
                            placeholder="Ex. 0912 345 6789" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                            dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400" required>
                    ...
                    <div>
                        <label for="company_name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Company
                            Name</label>
                        <input type="text" wire:model="company_name" id="company_name" placeholder="Ex. ABC Corporation"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                            dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400">
                        @error('company_name')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    ...
                    @if($country === 'Other')
                    <div>
                        <label for="otherCountry" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
