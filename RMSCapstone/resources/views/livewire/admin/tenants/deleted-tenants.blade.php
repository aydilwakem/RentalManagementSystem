    ...
    @else
        ...
        <div>
                        ...
                        @foreach ($deletedTenants as $tenant)
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3 space-x-2 text-center">
                                    <x-button wire:click="restoreTenant({{ $tenant->id }})" class="mb-2">
                                        Restore
                                    </x-button>
                                    <!-- Delete Forever Button -->
                                    <x-danger-button wire:click="confirmDeleteForever({{ $tenant->id }})">
                                        Delete Forever
                                    </x-danger-button>
                                </td>
                            </tr>
            ...
            <x-dialog-modal wire:model.live="confirmItemDelete">
                ...
                <x-slot name="content">
                    {{ __('Are you sure you want to permanently delete this tenant? This action cannot be undone.') }}
                </x-slot>
