<div>
    ...
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <!-- Event Category -->
            <div class="mb-4">
                <h3 class="text-lg font-semibold text-gray-900">Event Category</h3>
            ...
            <!-- Event Hall -->
            <div class="mb-4">
                <h3 class="text-lg font-semibold text-gray-900">Event Hall</h3>
                <p class="font-light text-gray-500">
                    {{ $event->eventHall->name }}
                </p>
            </div>
            ...
            <div class="mb-4">
                <h3 class="text-lg font-semibold text-gray-900">Contact Person Email</h3>
                <p class="font-light text-gray-500">
                    {{ $event->email }}
                </p>
            </div>
            ...
            <!-- Date Start-->
            <div class="mb-4">
                <h3 class="text-lg font-semibold text-gray-900">Event Date Start</h3>
                <p class="font-light text-gray-500">
                    {{\Carbon\Carbon::parse($event->event_date_start)->format('Y-m-d')}}
                </p>
            </div>

            {{-- Date End --}}
            <div class="mb-4">
                <h3 class="text-lg font-semibold text-gray-900">Event Date End</h3>
                <p class="font-light text-gray-500">
                    {{\Carbon\Carbon::parse($event->event_date_end)->format('Y-m-d')}}
                </p>
            </div>
