<div>
    ...
    <div class="py-3">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 bg-white rounded-lg border shadow-md p-6">
            ...
            <!-- Event Details -->
            <h3 class="text-lg font-bold text-green-800 mb-3">Event Schedule</h3>
            <div class="bg-gray-50 rounded-lg p-6 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-gray-600">
                    <div>
            ...
            {{-- Event Details --}}
            <h3 class="text-lg font-bold text-green-800 mb-3">Full Event Details</h3>
            <div class="bg-gray-50 rounded-lg p-6 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-gray-600">
                        ...
                        <table class="min-w-full border-collapse border border-gray-300 text-sm">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="border px-4 py-2 text-gray-700">{{ $payment->invoice->invoice_number }}
                                    </td>
            ...
            <!-- Action Buttons -->
            <div class="flex items-center justify-between space-x-4 mt-4 mb-3">
                <!-- Delete -->
