        ...
        <div>
                        ...
                        @foreach ($deletedEvents as $event)
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3 text-left">
                                    ...
                                    @else
                                        <span class="italic text-gray-500">User not found</span>
                                    @endif
                                </td>
                                <td class="px-4 py-3 text-left">
                                ...
                                <td class="px-4 py-3 space-x-2 text-center">
                                    <x-button wire:click="restoreEvent({{ $event->id }})" class="mb-2">
                                        Restore
                                    </x-button>
                                    <!-- Delete Forever Button -->
                                    <x-danger-button wire:click="confirmDeleteForever({{ $event->id }})">
                                        Delete Forever
                                    </x-danger-button>
                                </td>
                            </tr>
            ...
            <x-dialog-modal wire:model.live="confirmItemDelete" type="danger">
                ...
                <x-slot name="footer">
                    ...
                    <x-danger-button class="ms-3" wire:click="deleteEventForever({{ $event->id }})"
