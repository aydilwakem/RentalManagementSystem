<div class="min-h-[550px] container mx-auto p-6 max-w-full">
            ...
            <div class="flex">
                <div class="relative w-full">
                    ...
                    <input wire:model.live.debounce.300ms="search" type="text"
                        ...
                        placeholder="Search archived events..." required>
                </div>
            </div>
        </div>
                ...
                <table class="min-w-full text-left">
                    <thead wire:loading.remove wire:target="search"
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Event Start</th>
                        ...
                        @forelse ($events as $event)
                            <tr
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $event->transactionUser->company_name ?? 'N/A' }}
                                </td>
                                ...
                                <td class="px-4 py-3">{{ $event->event_type->name ?? 'N/A' }}</td>
                                ...
                                <td class="px-4 py-3">
                                    {{ \Carbon\Carbon::parse($event->end_datetime)->format('F j, Y') }}<br>
                                    {{ \Carbon\Carbon::parse($event->end_datetime)->format('g:i A') }}
                                </td>

                                <td class="px-4 py-3">
                                    {{ $event->updated_at->format('F j, Y') }}
                                </td>
                                    ...
                                    <div x-data="dropdown()" x-init="init" class="relative">
                                        ...
                                        <div x-show="open" x-ref="menu" @click.outside="open = false" x-transition
                                            ...
                                            <ul class="text-sm text-gray-700 dark:text-gray-200">
                                                <a href="{{ route('admin.view-event', ['event' => $event->id]) }}"
                                                ...
                                                <a href="#"
                                                    wire:click.prevent="showDeleteModal({{ $event->id }}, '{{ $event->transaction_number }}')"
    ...
    <x-dialog-modal wire:model.live="confirmingRestore" type="default">
        ...
        <x-slot name="footer">
            ...
            <x-button class="ms-3" wire:click="restoreEvent" wire:loading.attr="disabled">
                Restore
            </x-button>
        </x-slot>
    </x-dialog-modal>
