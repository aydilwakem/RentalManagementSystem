        ...
        <div class="bg-white rounded-lg shadow-md overflow-x-auto border">
            ...
            <table class="w-full text-left">
                <thead class="text-sm text-gray-700 bg-gray-200">
                    <tr>
                        {{-- Transaction Number --}}
                        <th scope="col" class="px-4 py-3" wire:click="setSortBy('id')"> <button
                        ...
                        <th scope="col" class="px-4 py-3" wire:click="setSortBy('end_datetime')"><button
                                class="flex items-center">
                                Event End
                ...
                <tr class="border-b">
                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                        <span>{{ $fakeIDs[$eventItem->id] ?? 'EVT-???' }}</span>
                    </th>
                    <td class="px-4 py-3">
                        {{ $eventItem->transactionUser->first_name }}
                        {{ $eventItem->transactionUser->last_name }}
