<div class="min-h-[550px] container mx-auto p-6 ">
    ...
    <div class="text-center py-10">
        <p class="text-gray-500 text-lg font-semibold">No deleted properties yet.</p>
    </div>
    @else
                ...
                <tbody class="text-center">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-3 space-x-2 text-center">
                            <x-button wire:click="restoreProperty({{ $property->id }})" class="mb-2">
                                Restore
                            </x-button>
                            <!-- Delete Forever Button -->
                            <x-danger-button wire:click="confirmDeleteForever({{ $property->id }})">
                                Delete Forever
                            </x-danger-button>
                        </td>
                    </tr>
