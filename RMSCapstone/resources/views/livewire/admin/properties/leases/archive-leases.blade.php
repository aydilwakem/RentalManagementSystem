<div class="min-h-[550px] container mx-auto p-6 max-w-full">
    <div class="mb-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Archived Leases</h2>
            </div>
            <x-button href="{{ route('admin.leases') }}" icon="fas fa-arrow-left" wire:navigate>
                Back to Leases
            </x-button>
        </div>
        <p class="text-gray-600 dark:text-gray-400 mt-2">
            Showing leases older than 5 years that have been automatically archived.
        </p>
    </div>
            ...
            <div class="flex">
                <div class="relative w-full">
                    ...
                    <input wire:model.live.debounce.300ms="search" type="text"
                        ...
                        placeholder="Search archived leases..." required>
                </div>
            </div>
        </div>
                ...
                <table class="min-w-full text-left">
                    <thead wire:loading.remove wire:target="search"
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Lease Duration</th>
                    ...
                    <tbody wire:loading.remove wire:target="search" class="text-left dark:bg-gray-700">
                        @forelse ($transactions as $transaction)
                            <tr class="border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white dark:border-gray-700 odd:dark:bg-gray-700 even:dark:bg-gray-800">
                                ...
                                <td class="px-4 py-3">
                                    {{ $transaction->properties->first()?->pivot->days ?? 'N/A' }} days
                                </td>
                                        ...
                                        <div x-show="open" x-ref="menu" @click.outside="open = false" x-transition
                                            ...
                                            <ul class="text-sm text-gray-700 dark:text-gray-200">
                                                <a href="{{ route('admin.view-lease', ['transaction' => $transaction->id]) }}"
                                                    ...
                                                    <i class="fas fa-eye mr-2 text-blue-600"></i> View Lease
                                                </a>
    ...
    <x-dialog-modal wire:model.live="confirmingRestore" type="default">
        ...
        <x-slot name="footer">
            ...
            <x-button class="ms-3" wire:click="restoreLease" wire:loading.attr="disabled">
                Restore
            </x-button>
        </x-slot>
    </x-dialog-modal>
