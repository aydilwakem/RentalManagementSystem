    ...
    @else
        ...
        <div>
                        ...
                        @foreach ($deletedLeases as $lease)
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3 space-x-2 text-center">
                                    <x-button wire:click="restoreLease({{ $lease->id }})" class="mb-2">
                                        Restore
                                    </x-button>
                                    <!-- Delete Forever Button -->
                                    <x-danger-button wire:click="confirmDeleteForever({{ $lease->id }})">
                                        Delete Forever
                                    </x-danger-button>
                                </td>
                            </tr>
            ...
            <x-dialog-modal wire:model.live="confirmItemDelete">
                ...
                <x-slot name="content">
                    {{ __('Are you sure you want to permanently delete this lease? This action cannot be undone.') }}
                </x-slot>
