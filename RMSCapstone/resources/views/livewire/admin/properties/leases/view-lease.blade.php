<div>
    ...
    <div class="py-3">
        <div
            ...
            <div class="bg-gray-50 rounded-lg p-6 mb-6 text-gray-600 dark:bg-gray-600 dark:border-gray-500 border">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 dark:text-gray-200">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @if ($transaction->invoice->invoice_status === 'pending')
                            <span
                                class="inline-block py-1 px-2 rounded-full text-sm font-semibold bg-yellow-100 text-yellow-600">
                                Pending
                            </span>
                        @elseif ($transaction->invoice->invoice_status === 'complete' || $transaction->invoice->invoice_status === 'completed')
                            <span
                                class="inline-block py-1 px-2 rounded-full text-sm font-semibold bg-green-100 text-green-600">
                                Completed
                            </span>
                        @elseif ($transaction->invoice->invoice_status === 'failed')
                            <span
                                class="inline-block py-1 px-2 rounded-full text-sm font-semibold bg-red-100 text-red-600">
                                Failed
                            </span>
                        @elseif ($transaction->invoice->invoice_status === 'overdue')
                            <span
            ...
            <div class="justify-between flex items-center mb-3">
                <h3 class="text-lg font-bold text-green-800  dark:text-green-300">Payments
                        ...
                        <div>
                            ...
                            <div class="sm:col-span-2 mt-4">
                                <label for="payment_screenshot"
                                    class="block text-sm text-gray-700 font-semibold mb-3">Proof
                                    of
                ...
                <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div
                        ...
                        <div>
                            ...
                            <div class="mt-4">
                                <label class="block text-sm text-gray-700 font-semibold mb-3">Proof of Payment</label>
