<div>
    ...
    <x-slot name="header">
        ...
        <x-breadcrumbs :items="[
            ...
            ['label' => 'Create Property', 'url' => route('admin.create-property')],
        ]" />
    </x-slot>
        ...
        <div
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 col-span-2">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="postal_code" id="postal_code" required readonly
            ...
            <x-dialog-modal wire:model.live="confirmCreateItem">
                ...
                <x-slot name="footer">
                    ...
                    <x-button class="ms-3 bg-green text-white" wire:click="saveProperty"
