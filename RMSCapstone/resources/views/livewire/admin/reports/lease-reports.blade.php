    ...
    <div class="overflow-x-auto p-3 mb-3">
        <div class="flex items-center justify-between p-4">
            <div class="flex gap-4 w-full">
                ...
                {{-- Select A Property --}}
                <div class="w-full">
                    <label for="select_property"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Select a Property
                    </label>
                    <select wire:model.live="propertyFilter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                            dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400">
                ...
                <div class="w-full">
                    <label for="property_status"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Lease
                        Status:</label>
                    <select id="property_status" name="event_status" wire:model.live="propertyStatusFilter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                            dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400">
        ...
        <div class="flex justify-end mb-2 space-x-2 mr-4">
            ...
            {{-- EXPORT EXCEL --}}
            <div class="relative">
                <x-warning-button icon="fa-solid fa-file" wire:click="exportLeaseExcel" wire:loading.attr="disabled">
                    Export Excel
                </x-warning-button>

                <div wire:loading wire:target="exportLeaseExcel"
                    class="absolute inset-0 flex items-center justify-center bg-white/70 rounded pl-4">
                    ...
                    <tbody class="text-left dark:bg-gray-700">
                        ...
                        <tr
                            ...
                            <th scope="row"
                                ...
                                {{ $fakeIDs[$transaction->id] ?? 'LSE-' . str_pad($loop->index + 1, 3, '0',
                                STR_PAD_LEFT) }}
                            </th>
