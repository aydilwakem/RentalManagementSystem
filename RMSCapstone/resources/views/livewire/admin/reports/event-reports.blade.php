    ...
    <div class="overflow-x-auto p-3 mb-3">
        <div class="flex items-center justify-between p-4">
            <div class="flex gap-4 w-full">
                ...
                {{-- Select A Hall --}}
                <div class="w-full">
                    <label for="select_hall"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Select a Hall
                    </label>
                    <select wire:model.live="hallFilter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                            dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400">
                ...
                <div class="w-full">
                    <label for="event_status"
                        ...
                        Status:</label>
                    <select id="event_status" name="event_status" wire:model.live="eventStatusFilter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5
                            dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400">
                    ...
                    <tbody class="text-left dark:bg-gray-700">
                        ...
                        <tr
                            ...
                            <th scope="row"
                                ...
                                {{ $fakeIDs[$transaction->id] ?? 'EVT-' . str_pad($loop->index + 1, 3, '0',
                                STR_PAD_LEFT) }}
                            </th>
                            ...
                            <td class="px-4 py-3">
                                ...
                                <br>
                                {{ \Carbon\Carbon::parse($transaction->start_datetime)->format('g:i A') }}
                            </td>
                            ...
                            <td class="px-4 py-3">
                                ...
                                <br>
                                {{ \Carbon\Carbon::parse($transaction->end_datetime)->format('g:i A') }}
                            </td>
