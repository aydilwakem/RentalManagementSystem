    ...
    <div class="overflow-x-auto p-3 mb-3">
        <div class="flex items-center justify-between p-4">
            <div class="flex gap-4 w-full">
                ...
                {{-- Select A Room --}}
                <div class="w-full">
                    <label for="select_room" class="block mb-2 text-sm font-medium text-gray-900">Filter by Room
                    </label>
        ...
        @else
            @if (!empty($filteredTransactions))
                ...
                <div class="flex justify-end mb-2 space-x-2 mr-4">
                    {{-- EXPORT PDF BUTTON --}}
                    <div class="relative">
                        <x-button icon="fa-solid fa-file" wire:click="exportReservationSummary"
