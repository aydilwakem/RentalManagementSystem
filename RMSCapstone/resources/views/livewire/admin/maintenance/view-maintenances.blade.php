<div class="min-h-[550px] container mx-auto p-6 ">
    ...
    <div>
        ...
        <div
            ...
            <div class="flex items-center justify-between d p-4">
                ...
                <div class="flex space-x-3">
                    <div class="flex space-x-3 items-center">
                        ...
                        <select wire:model.live="priorityStatus" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5
                                dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
            ...
            {{-- Table --}}
            <div wire:loading wire:target="search, priorityStatus"
            ...
            <table class="w-full text-left">
                <thead wire:loading.remove wire:target="search, priorityStatus"
                ...
                <tbody wire:loading.remove wire:target="search, priorityStatus" class="dark:bg-gray-700">
