<div>
    <x-slot name="header">
        ...
        <x-breadcrumbs :items="[
            ...
            ['label' => 'Edit Day Tour Rate', 'url' => route('admin.edit-day-tour-rate', ['dayTourRate' => $dayTourRate->id])],
        ]" />
    </x-slot>
    ...
    <div class="py-3">
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8 bg-white rounded-xl border shadow-md p-6 dark:bg-gray-700 dark:text-white dark:border-gray-600">
            ...
            <div class="relative flex items-center mb-4">
                <h2 class="text-2xl font-bold text-gray-900 w-full text-center dark:text-white">Edit Day Tour Rate</h2>
            ...
            <form wire:submit.prevent="">
                <div class="grid gap-4 md:grid-cols-2 sm:gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select wire:model="day_tour_id" id="day_tour_id" required
        ...
        <x-dialog-modal wire:model.live="confirmEditItem">
            ...
            <x-slot name="content">
                {{ __('Are you sure you want to save changes to this day tour rate?') }}
            </x-slot>
            ...
            <x-slot name="footer">
                ...
                <x-button class="ms-3 bg-green text-white" wire:click="updateDayTourRate" wire:loading.attr="disabled">
                    {{ __('Save Changes') }}
                </x-button>
            </x-slot>
        </x-dialog-modal>
