            ...
            <div class="bg-white shadow-lg rounded-lg border border-gray-200 p-6 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div>
                    ...
                    @if (!empty($transaction->requests))
                        <div class="mt-2">
                            <span
                                class="inline-block bg-gray-100 text-gray-700 text-sm px-3 py-2 rounded-lg shadow-sm self-start"">
                                {{ Str::limit($transaction->requests, 50) }}
                            </span>

                            <x-button wire:click="openModal('requests')" icon="fas fa-comment-dots" class="self-start">
                                View & Reply
                            </x-button>
