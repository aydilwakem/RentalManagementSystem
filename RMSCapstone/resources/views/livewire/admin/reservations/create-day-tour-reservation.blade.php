    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white shadow-md rounded-lg border border-gray-200 p-6 dark:bg-gray-700 dark:border-gray-600">
            ...
            @if($tour_date)
                <p class="text-sm text-gray-500 mb-4 dark:text-gray-300">
                    Showing rates for: {{ \Carbon\Carbon::parse($tour_date)->format('M d, Y') }} ({{ $this->getDayType($tour_date) }})
                </p>
            @endif
        ...
        {{-- <div class="bg-white shadow-md rounded-lg border border-gray-200 p-6 dark:bg-gray-700 dark:border-gray-600">
            <div class="flex flex-col space-y-2 w-full">
                ...
                <div class="mt-6">
                    @if (count($guests) > 0)
                        <ol class="space-y-3 list-decimal pl-6 text-gray-700 mb-3 p-3 bg-white rounded-2xl border border-gray-300 dark:bg-gray-600 dark:border-gray-500">
                    ...
                    @else
                        <p class="text-center text-gray-500 mt-6 mb-6 dark:text-gray-200">No additional guests added yet.</p>
                    @endif
                </div>
            </div>
        </div> --}}
