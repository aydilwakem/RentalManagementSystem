<div>
    ...
    <div>
        ...
        <div class="bg-white shadow-lg rounded-lg border border-gray-300 p-4">
            ...
            <p><strong>Duration of Stay:</strong> {{ $transaction->properties->first()?->pivot->days ?? 'N/A' }}
                day(s)
            </p>
                        ...
                        @foreach ($properties as $property)
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-right">
                                    ₱{{ number_format($property->pivot->amount ?? 0, 2) }}
                                </td>
                                <td class="border px-4 py-2 text-right">
                        ...
                        @foreach ($activities as $activity)
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-center">
                                    {{ $property->pivot->quantity ?? 'N/A' }}
                                </td>
                                <td class="border px-4 py-2 text-right"> ₱{{ number_format($activity->amount, 2) }}</td>
                                <td class="border px-4 py-2 text-right">
                                    ₱{{ number_format($activity->amount * ($activity->pivot->quantity ?? 0), 2) }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
