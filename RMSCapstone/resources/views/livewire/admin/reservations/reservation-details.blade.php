    ...
    <div style="background-color: #fff; border: 1px solid #ccc; border-radius: 8px; padding: 20px; margin-top: 30px;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 14px; color: #374151;">
            ...
            <tr>
                ...
                <td style="padding: 8px; font-size: 14px;">PHP{{ number_format($convenienceFeeTotal, 2) }}</td>
            </tr>
            <tr>
                ...
                <thead style="background-color: #166534; color: #fff;">
                    <tr>
                        ...
                        <th
                            ...
                            Type</th>
                        <th
                            style="border: 1px solid #d1d5db; padding: 4px 6px; font-weight: bold; width: 13%; text-align: center; font-size: 14px;">
                            Ref No.</th>
                        <th
                            style="border: 1px solid #d1d5db; padding: 4px 6px; font-weight: bold; width: 10%; text-align: center; font-size: 14px;">
                            Date</th>
                ...
                <tbody>
                    @foreach ($payments as $payment)
                        <tr>
                            ...
                            <td
                                style="border: 1px solid #d1d5db; padding: 4px 6px; white-space: normal; word-wrap: break-word; text-align: center; font-size: 14px;">
                            ...
                            <td
                                style="border: 1px solid #d1d5db; padding: 4px 6px; text-align: center; font-size: 14px;">
                                {{ $payment->verified_at
                                    ? \Carbon\Carbon::parse($payment->verified_at)->format('M j, Y')
                                    : 'To
                                                        be verified' }}
                            </td>
                        </tr>
