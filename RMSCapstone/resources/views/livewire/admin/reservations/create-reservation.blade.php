            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-4 mb-4">
                ...
                <div class="col-span-1">
                    ...
                    <input type="tel" inputmode="numeric" maxlength="11" id="phone" name="phone"
                        ...
                        placeholder="Ex. 09123456789" class="!w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400
                        dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                        ...
                        <div wire:key="room-{{ $room->id }}"
                            ...
                            <div class="flex flex-col md:flex-row md:space-x-6">
                                ...
                                <div class="md:w-2/3 space-y-2">
                                    ...
                                    <p class="tblock text-sm font-medium text-gray-700 mb-1 dark:text-gray-200">
                                    ...
                                    <p class="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-200">
                                    ...
                                    <p class="mt-3 text-base font-medium text-gray-800">
                                        ...
                                        <span class="mt-2 inline-block py-1 px-2 rounded-full text-xs font-semibold mb-2
