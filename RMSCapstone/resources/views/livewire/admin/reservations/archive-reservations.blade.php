    ...
    <div class="mb-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Archived Reservations</h2>
            </div>
            <x-button href="{{ route('admin.reservations-list') }}" icon="fas fa-arrow-left" wire:navigate>
