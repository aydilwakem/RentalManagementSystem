        ...
        <div class="p-6">
            ...
            <form wire:submit.prevent="rebook">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="date" wire:model.live="check_in_date" min="{{ $min_date }}"
                                max="{{ $max_date }}"
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    <x-secondary-button type="button" href="{{ route('admin.reservations-list') }}">
                        Cancel
                    </x-secondary-button>
                    <x-button type="submit" icon="fas fa-calendar-check" :disabled="!$check_in_date || $stay_duration === 0 || $errors->has('check_in_date')">
                        Rebook Reservation
                    </x-button>
                </div>
            </form>
