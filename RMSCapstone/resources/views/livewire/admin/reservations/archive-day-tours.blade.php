<div class="min-h-[550px] container mx-auto p-6 max-w-full">
    <div class="mb-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Archived Day Tours</h2>
            </div>
            <x-button href="{{ route('admin.daytour-reservations-list') }}" icon="fas fa-arrow-left" wire:navigate>
                Back to Day Tours
            </x-button>
        </div>
        <p class="text-gray-600 dark:text-gray-400 mt-2">
            Showing day tours older than 5 years that have been automatically archived.
        </p>
    </div>
            ...
            <div class="flex">
                <div class="relative w-full">
                    ...
                    <input wire:model.live.debounce.300ms="search" type="text"
                        ...
                        placeholder="Search archived day tours..." required>
                </div>
            </div>
        </div>
    ...
    <x-dialog-modal wire:model.live="confirmingRestore" type="default">
        ...
        <x-slot name="footer">
            ...
            <x-button class="ms-3" wire:click="restoreDayTour" wire:loading.attr="disabled">
                Restore
            </x-button>
        </x-slot>
    </x-dialog-modal>
