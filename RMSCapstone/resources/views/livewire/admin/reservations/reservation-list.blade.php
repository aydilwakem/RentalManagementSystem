    ...
    <div
        ...
        <div class="flex items-center justify-between p-4 dark:bg-gray-800 rounded-lg">
            ...
            <div class="flex space-x-3">
                <div class="flex space-x-3 items-center">
                    ...
                    <select wire:model.live="statusFilter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5
                            dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
        ...
        <div>
            <table class="min-w-full text-left">
                ...
                {{-- TODO: fix table loading state
                <tbody wire:loading wire:target="search, statusFilter, perPage">
                    @include('livewire.admin.placeholder')
                </tbody>
                wire:loading.remove wire:target="search, statusFilter, perPage" --}}
                ...
                <tbody class="text-left dark:bg-gray-700">
                    ...
                    <tr
                        class="border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white dark:border-gray-700 odd:bg-gray-50 even:bg-white odd:dark:bg-gray-700 even:dark:bg-gray-800">
