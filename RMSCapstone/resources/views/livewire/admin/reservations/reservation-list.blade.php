                ...
                <table class="min-w-full text-left">
                    ...
                    <tbody class="text-left dark:bg-gray-700">
                        ...
                        @forelse ($transactions as $transaction)
                            <tr class="border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white dark:border-gray-700 odd:bg-gray-50 even:bg-white odd:dark:bg-gray-700 even:dark:bg-gray-800">
