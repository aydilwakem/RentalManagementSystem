<div class="min-h-[550px] container mx-auto p-6 ">
    @if ($transactions->isEmpty())
        ...
        <div class="text-center py-10">
            <p class="text-gray-500 text-lg font-semibold">No confirmed reservations yet.</p>
            <x-button class="mt-4" href="{{ route('admin.view-new-transactions') }}" icon="fas fa-check" wire:navigate>
                        ...
                        @foreach ($transactions as $transaction)
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-3 flex items-center justify-center space-x-3">
                                    ...
                                    <i class="fa-solid fa-circle-check text-gray-700 hover:text-green-600 cursor-pointer"
                                        wire:click="confirmReservation({{ $transaction->id }})" wire:loading.attr="disabled">
                                    </i>
