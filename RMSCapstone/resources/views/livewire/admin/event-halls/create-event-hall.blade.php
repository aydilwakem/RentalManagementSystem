        ...
        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" wire:model="name_number" id="name_number"
                    ...
                    placeholder="Enter event hall name" required>
                @error('name_number')
            ...
            <div class="sm:col-span-2">
                ...
                <textarea wire:model="description" id="description" rows="3"
                    ...
                    placeholder="Describe your event hall"></textarea>
                @error('description')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <!-- Capacity -->
            <div>
                <label for="capacity" class="block mb-2 text-sm font-medium text-gray-900">Maximum Capacity</label>
            ...
            <div>
                ...
                <input type="text" wire:model="extra_charge_per_hour" id="extra_charge_per_hour" rows="8"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500"
            ...
            <div class="mb-4 col-span-2">
                <label for="images" class="block mb-2 text-sm font-medium text-gray-900">Upload Event Hall Image(s)</label>
