            ...
            <div class=" bg-white-500 relative shadow-md sm:rounded-lg overflow-hidden border">
                ...
                <table class="w-full text-left">
                    ...
                    @forelse ($halls as $hall)
                        <tr class="border-b">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap space-x-2">
                                <input wire:model.live="selectedRows" type="checkbox" name="halls[]"
                                    value="{{ $hall->id }}" class="accent-blue-600 w-4 h-4">
                                    <span>{{ $fakeIDs[$hall->id] ?? 'HALL-???' }}</span>
                            </th>
