<div>
    ...
    <x-slot name="header">
        ...
        <x-breadcrumbs :items="[
            ...
            ['label' => 'View Feature', 'url' => route('admin.view-feature', ['feature' => $feature->id])],
            ['label' => 'Edit Feature', 'url' => route('admin.edit-feature', ['feature' => $feature->id])],
        ]" />
    </x-slot>
    ...
    <div class="py-3">
        <div
            ...
            <form wire:submit.prevent="" class="flex flex-col space-y-6 min-h-[200px]">
                <!-- Name of Feature -->
                <div class="mt-4">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Feature Name
