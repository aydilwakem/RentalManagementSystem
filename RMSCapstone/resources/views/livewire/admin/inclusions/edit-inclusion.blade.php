<div class="min-h-[550px] container mx-auto p-6 bg-white rounded-lg">
    ...
    <div class="shadow-lg rounded-lg p-6 max-w-2xl mx-auto border mt-16 bg-white">
        <h2 class="mb-4 text-xl font-bold text-gray-900 text-center">Edit Inclusion</h2>
        ...
        <form wire:submit.prevent="">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-2">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Inclusion Name</label>
            ...
            <div class="flex justify-between items-center space-y-2 mt-6">
                ...
                <x-button type="submit" class="mt-4" wire:click="confirmEdit({{ $inclusion->id }})">
                    Save Changes
                </x-button>
            </div>
        </form>
