            ...
            <div
                ...
                <div class="flex items-center justify-between d p-4">
                    ...
                    <div class="flex space-x-3">
                        <div class="flex space-x-3 items-center">
                            <label class=" text-sm font-medium text-gray-900 dark:text-white">Inclusion Type:</label>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 flex items-center justify-center space-x-4">
                                ...
                                <i class="fas fa-trash-alt text-gray-700 hover:text-red-600 cursor-pointer"
                                    wire:click="confirmDelete({{ $inclusion->id }})" wire:loading.attr="disabled">
                                </i>
                                @endcan
                ...
                <x-dialog-modal wire:model.live="confirmItemDelete" type="danger">
                    ...
                    <x-slot name="footer">
                        ...
                        <x-danger-button class="ms-3" wire:click="deleteInclusion" wire:loading.attr="disabled">
                            {{ __('Delete Inclusion') }}
                        </x-danger-button>
                    </x-slot>
                </x-dialog-modal>
