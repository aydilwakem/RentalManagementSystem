        ...
        <div>
            ...
            <div
                ...
                <table class="w-full text-left">
                    ...
                    dark:bg-gray-800 dark:text-white dark:border-t dark:border-gray-700">
                        <tr>
                    ...
                    <tbody wire:loading.remove wire:target="search" class="text-left dark:bg-gray-700">
                        @forelse ($inclusions as $inclusion)
                            <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-600 dark:border-gray-700 odd:dark:bg-gray-700 even:dark:bg-gray-800">
                                ...
                                <td class="px-4 py-3 font-semibold text-gray-900 dark:text-white">{{ $inclusion->name }}</td>
                ...
                {{-- Pagination --}}
                <div class="py-6 px-4 rounded-xl shadow-sm">
