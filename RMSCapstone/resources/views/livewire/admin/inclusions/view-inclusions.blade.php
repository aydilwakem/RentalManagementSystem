<div class="min-h-[550px] container mx-auto p-6 rounded-lg">
    @if ($inclusions->isEmpty() && !$search && !$propertyFeatureType)
        <!-- Empty Page Message -->
        ...
        <div>
            ...
            <div
                ...
                <div
                    ...
                    <!-- Header-->
                    <div
                        class="flex flex-col md:flex-row md:items-center md:justify-between p-4 space-y-2 md:space-y-0">
                        <!-- Search-->
                        <div class="flex">
                        ...
                        <div class="flex space-x-3">
                            <div class="flex space-x-3 items-center">
                                <label class=" text-sm font-medium text-gray-900 dark:text-white md:w-auto w-full">Inclusion
                                    Type:</label>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-4 py-3 flex items-center justify-center space-x-3">
                                            ...
                                            @can('event-inclusions-view')
                                                {{-- View --}}
                                                <i class="fas fa-eye text-gray-700 hover:text-blue-600 cursor-pointer dark:text-gray-100 dark:hover:text-blue-500"
                                                    wire:navigate
                                            ...
                                            @can('event-inclusions-edit')
                                                {{-- Edit --}}
                                                <i class="fas fa-edit text-gray-700 hover:text-yellow-600 cursor-pointer dark:text-gray-100 dark:hover:text-yellow-500"
                                                    wire:navigate
                                            ...
                                            @can('event-inclusions-delete')
                                                {{-- Delete --}}
                                                <i class="fas fa-trash-alt text-gray-700 hover:text-red-600 cursor-pointer dark:text-gray-100 dark:hover:text-red-500"
                    ...
                    {{-- Pagination --}}
                    <div class="py-6 px-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                        <div class="flex justify-between items-center mb-4">
                            <div class="flex items-center space-x-3">
                                <label class="text-sm font-semibold text-gray-700 dark:text-gray-100">Per Page</label>
                    ...
                    <x-dialog-modal wire:model="cannotDeleteItem" type="ghost">
                        ...
                        <x-slot name="content">
                            {{ __('This inclusion is currently active and cannot be deleted.') }}
                        </x-slot>

                        <x-slot name="footer">
                            <x-secondary-button wire:click="$set('cannotDeleteItem', false)"
                                wire:loading.attr="disabled">
                                {{ __('OK') }}
                            </x-secondary-button>
                        </x-slot>
