    ...
    <div class="py-3">
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8 bg-white rounded-xl border shadow-md p-6">
            ...
            <form wire:submit.prevent="" class="flex flex-col h-full space-y-6 min-h-[200px]">
                <!-- Name of Inclusion -->
                <div class="mt-4">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Inclusion Name <span
        ...
        <x-dialog-modal wire:model.live="confirmCreateItem">
            ...
            <x-slot name="footer">
                ...
                <x-button class="ms-3 bg-green text-white" wire:click="saveInclusion" wire:loading.attr="disabled">
                    {{ __('Create Inclusion') }}
                </x-button>
            </x-slot>
        </x-dialog-modal>
