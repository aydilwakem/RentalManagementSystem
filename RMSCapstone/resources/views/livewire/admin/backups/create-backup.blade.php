        ...
        <div class="p-6">
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-6">
                <div class="flex items-start">
                    <svg class="h-6 w-6 text-blue-600 dark:text-blue-400 mr-3 mt-1" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md p-4">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300">Full Database Backup (MySQL
                                Dump)</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
                    <x-ghost-button icon="fas fa-arrow-left" href="{{ route('admin.view-backups') }}">
                        Cancel
                    </x-ghost-button>

                    <x-button icon="fas fa-download" type="button" wire:click="createBackup"
                        wire:loading.attr="disabled" :disabled="$isCreating">
                        <span wire:loading.remove>Create Backupc</span>
