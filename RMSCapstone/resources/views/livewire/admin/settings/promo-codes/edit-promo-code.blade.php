    ...
    <div class="py-3">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 bg-white rounded-xl border shadow-md p-6 dark:text-white dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="relative flex items-center mb-4">
                <!-- Title -->
                <h2 class="text-2xl font-bold text-gray-900 w-full text-center dark:text-white">Edit Promo Code</h2>
            ...
            <form wire:submit.prevent="">
                ...
                <div class="flex justify-between items-center space-y-2 mt-6">
                    ...
                    <x-button wire:loading.attr="disabled" wire:click="confirmEdit({{ $promoCode->id }})">
                        Save Changes
                    </x-button>
                </div>
            </form>
            ...
            <x-dialog-modal wire:model.live="confirmEditItem">
                ...
                <x-slot name="footer">
                    ...
                    <x-button class="ms-3 bg-green text-white" wire:click="updatePromoCode({{ $promoCode->id }})"
