    ...
    <div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-x-auto border">
            ...
            <table class="w-full text-left">
                <thead class="text-sm text-gray-700 bg-gray-200">
                    <tr>
                        ...
                        {{-- Discount Type --}}
                        <th scope="col" class="px-4 py-3" wire:click="setSortBy('discount_type')">
                            <button class="flex items-center">
                                Discount Type
                        ...
                        <th scope="col" class="px-4 py-3 ">Maximum Uses</th>
                        <th scope="col" class="px-4 py-3 ">Per User Limit</th>
                        <th scope="col" class="px-4 py-3 ">Minimum Booking Amount</th>
                        <th scope="col" class="px-4 py-3 ">Start Date</th>
                        <th scope="col" class="px-4 py-3 ">End Date</th>
                        <th scope="col" class="px-4 py-3 ">Duration Days</th>
                        <th scope="col" class="px-4 py-3 ">Assigned Room Category</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-gray-900 font-semibold"> {{ $promoCode->code }}</td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3"> {{ $promoCode->max_uses }}</td>
                        <td class="px-4 py-3"> {{ $promoCode->per_user_limit }}</td>
                        <td class="px-4 py-3"> {{ $promoCode->min_booking_amount }}</td>
                        <td class="px-4 py-3"> {{ \Carbon\Carbon::parse($promoCode->start_date)->format('F j, Y') }}
                        </td>
                        <td class="px-4 py-3"> {{ \Carbon\Carbon::parse($promoCode->end_date)->format('F j, Y') }}</td>
                        <td class="px-4 py-3"> {{ $promoCode->duration_days }} days</td>
                        <td class="px-4 py-3">{{ $promoCode->propertyCategory->name ?? 'No Assigned Property' }}</td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3 flex items-center justify-center space-x-3">
                            ...
                            <i class="fas fa-trash-alt text-gray-700 hover:text-red-600 cursor-pointer"
                                wire:click="confirmDelete({{ $promoCode->id }})" wire:loading.attr="disabled">
                            </i>
            ...
            <x-dialog-modal wire:model="cannotDeleteItem" type="ghost">
                ...
                <x-slot name="content">
                    {{ __('This promo code is currently in use and cannot be deleted.') }}
                </x-slot>
