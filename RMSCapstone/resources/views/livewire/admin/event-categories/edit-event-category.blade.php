<div>
    ...
    <x-slot name="header">
        ...
        <x-breadcrumbs :items="[
            ...
            ['label' => 'Edit Event Category', 'url' => route('admin.edit-event-category', ['eventCategory' => $eventCategory->id])],
        ]" />
    </x-slot>
            ...
            <form wire:submit.prevent="">
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">Category Name <span
                ...
                <div class="flex justify-between items-center space-y-2 mt-6">
                    ...
                    <x-button type="submit" wire:loading.attr="disabled" wire:click="confirmEdit({{ $eventCategory->id }})">
                        Save Changes
                    </x-button>
                </div>
            </form>
