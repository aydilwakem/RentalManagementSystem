                ...
                <tr class="border-b">
                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                        <input wire:model.live="selectedRows" type="checkbox" name="eventCategory[]"
                            value="{{ $eventCategory->id }}" class="accent-blue-600 w-4 h-4">
                    </th>
                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                        {{ $fakeIDs[$eventCategory->id] ?? 'ECT-???' }}
                    </th>
                    <td class="px-4 py-3"> {{ $eventCategory->name }}</td>
                    <td class="px-4 py-3"> @if (!empty($eventCategory->description))
                    ...
                    <td class="px-4 py-3 flex items-center justify-center space-x-3">
                        ...
                        <i class="fas fa-trash-alt text-gray-700 hover:text-red-600 cursor-pointer"
                            wire:click="confirmDelete({{ $eventCategory->id }})" wire:loading.attr="disabled">
                        </i>
                        @endcan
