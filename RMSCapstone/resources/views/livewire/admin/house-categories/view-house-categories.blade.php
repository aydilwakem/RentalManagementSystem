<div class="min-h-[550px] container mx-auto p-6 bg-white rounded-lg">
    @if ($houseCategories->isEmpty())
    <!-- Empty Page Message -->
    <div class="text-center py-10">
        <p class="text-gray-500 text-lg font-semibold">No house categories yet.<br> Click "Create House Category" to add
            a new
            category.</p>
        <x-button class="mt-4" href="{{ route('admin.create-house-category') }}" icon="fas fa-plus" wire:navigate>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="text-left">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-3 text-gray-900">{{ $houseCategory->name }}</td>
                        <td class="px-4 py-3 text-gray-900">@if (!empty($houseCategory->description))
