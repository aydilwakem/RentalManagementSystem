            ...
            <div class="flex flex-col items-center p-8 bg-white bg-opacity-90 rounded-3xl shadow-xl w-full max-w-sm">
                ...
                <div class="w-full flex flex-col items-center justify-center">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="w-full space-y-6 mt-2">
                        ...
                        <!-- Login Button -->
                        <button type="submit"
                            class="w-full py-3 px-6 rounded-full text-white font-bold bg-green-800 hover:bg-green-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 transition duration-150 ease-in-out">
                            LOGIN
                        </button>
